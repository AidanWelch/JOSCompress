...
class Schema {
     ...
     * 
     * @param {Object} message The object message, matching the schema, to encode.  All quotation marks(not apostraphes) must be escaped or errors occur.
    ...
    decode(message, permissive = false){
        ...
        } else if (typeof this.schema === 'object' && this.schema !== null) {
